...
import type { LanguageCode, ASRMethodConfig } from '../types';

/** Advanced options component props */
...
export function AdvancedOptions({
  ...
  const handleVadChange = (field: 'minSpeechDuration' | 'minSilenceDuration', value: string) => {
    const defaultValue = field === 'minSpeechDuration' ? DEFAULT_MIN_SPEECH_DURATION : DEFAULT_MIN_SILENCE_DURATION;
    onVadConfigChange(field, parseInt(value) || defaultValue);
  };
